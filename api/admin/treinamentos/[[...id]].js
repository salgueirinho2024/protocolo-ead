...
module.exports = async (req, res) => {
  ...
  // req.query.id vem como array por causa do catch-all opcional [[...id]]
  const segmentos = Array.isArray(req.query.id) ? req.query.id : [];
  ...
  if (segmentos.length === 2 && segmentos[1] === 'modulos') {
    return handleModulos(req, res, segmentos[0]);
  }
