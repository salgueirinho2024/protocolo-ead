...
function htmlCertificado({ nome, cpf, titulo, cargaHorariaMin, data, codigo, validoAte }) {
  return `<!DOCTYPE html>
<html lang="pt-BR">
<head>
<meta charset="UTF-8">
...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .footer { display: flex; gap: 48px; justify-content: center; }
...
async function gerarCertificadoPDF(matriculaId, funcionarioId) {
  ...
  const pdfBuffer = await gerarPdfBuffer({
    ...
    data: dataFormatada, codigo, validoAte: validoAteFormatado,
  });
